...
<div class="index-menu-back-div"> 
    ...
    <div class="div-in">
        ...
        <div class="div">
            ...
            <li <?php if ($page=='product') {?> id="active-li"<?php }?>><i class="bi-building-check"></i> Shop</li></a>
        </div>

        <div class="div">
            <li onclick="_open_li('tutorial')"><i class="bi-activity"></i> Pages <i class="bi-plus" id="side-expand"></i></li>
            <div class="sub-li" id="tutorial-sub-li">
                <ul class="expand-div">
                <a href="<?php echo $website_url ?>/about" title="About"><li>About us</li></a>
                <a href="<?php echo $website_url ?>/services" title="services"><li>Services</li></a>
                <a href="<?php echo $website_url ?>/contact" title="contact"><li>Contact us</li></a>
                <a href="<?php echo $website_url ?>/faq" title="faq"><li>FAQ</li></a>
                </ul>
            </div>
        </div>
        ...
        <div class="div">
            ...
            <li <?php if ($page=='blog') {?> id="active-li"<?php }?>><i class="bi-person-check"></i> Blog</li></a>
        </div>
