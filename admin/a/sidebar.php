<div class="side-bar">
    <div class="div-in">
        <div class="img-div">
            <img src="./all-images/logo.png" alt="logo">
        </div>
        <div class="list-div">
            <ul>
                ...
                <li class="active-li" onclick="_getPage('blog', 'blog')" id="blog"><i class="bi-chat-left-text"></i> Blog <div class="pin"><i class="bi-pin"></i> </div>
                <div class="hidden" id="_blog"><i class="bi-people"></i> All Active Blog</div>
            </li>
                <li class="active-li" onclick="_getPage('faq', 'faq')" id="faq"><i class="bi-patch-question"></i> FAQ <div class="pin"><i class="bi-pin"></i> </div>
                <div class="hidden" id="_faq"><i class="bi-people"></i> All Active Faq</div>
            </li>         
            </ul>
